 ...
 * Describle;
 */
public class AudioService extends Service implements EventListener {
    ...
    private void loopRecord() {
        delaymills = SystemHelper.batteryInfo(getApplicationContext());
    ...
    public static interface Callback {
        ...
        void onVolumeChange(double data);
    }
    ...
    private void start() {
        ...
        params.put(SpeechConstant.VAD_ENDPOINT_TIMEOUT, 800); // 尾点检测 1000ms
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_PARTIAL)) {
            if (params != null) {
                String[] results_recognition = RecogResult.parseJson(params).getResultsRecognition();

                if (results_recognition != null) {

                    for (String s : results_recognition) {
                        str = s;
                        // Log.i("getResultsRecognition()",s);
                    }
                }
            ...
            if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_FINISH)) {
                ...
                //     Log.i("results_recognition", Arrays.toString(results_recognition));
